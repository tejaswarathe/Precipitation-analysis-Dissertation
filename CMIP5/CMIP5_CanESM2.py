...
count = 0
total_prcpt_in_the_year = np.zeros([6,11])

cdd_matrix = np.zeros([6,11])
current_cdd_matrix = np.zeros([6,11])
...
period1 = 'CMIP5/0Major 4/CanESM2/'
period2 = 'CMIP5/0Major 4/CanESM2/'
...
plt.pyplot.title('Total precipitation--Period1--CanESM2')
