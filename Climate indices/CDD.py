...
count = 0
cdd_matrix = np.zeros([53,113])
current_cdd_matrix = np.zeros([53,113])
...
# Plot Data
cs = map.pcolor(x, y, cdd_matrix, cmap='gist_rainbow', shading='auto')
...
plt.pyplot.title('Consecutive Dry days')
