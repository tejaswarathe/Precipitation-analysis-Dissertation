...
model = 'CMIP5/0Major 4/CNRM-CM5/historical/'
...
#         print(fh.variables)
        ...
        bottomLat = np.where(lats == 24.51342010498047)[0][0]
        topLat = np.where(lats == 38.52105712890625)[0][0]
        ...
        if(file.name == 'pr_day_CNRM-CM5_historical_r1i1p1_19800101-19841231.nc'):
            ppt = ppt[366:]
            print(ppt.shape)
...
plt.title('Model Validation - CNRM-CM5')
