...
def calculateMeanPrecipitation(month):
    global mean_precipitation, total_precipitation, numOfdays
    print(numOfdays[month])
    mean_precipitation[month] = np.true_divide(total_precipitation[month], numOfdays[month])
...
calculateMeanPrecipitation(month)
...
# Plot Data
cs = map.pcolor(y, x, mean_precipitation[month], cmap='gist_rainbow', shading='auto', vmin=minmin, vmax=maxmax)
